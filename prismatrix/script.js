...
window.addEventListener('scroll', () => {
    ...
    if ((scrollPosition > section4OffsetTop) && (scrollPosition <section4Height + section4OffsetTop)) {
        if (scrollPosition > section4OffsetTop && scrollPosition < section4OffsetTop + 300) {
            ...
            section4Left1.style.transition = "opacity is ease-in-out";
            ...
            section4Left2.style.transition = "opacity is ease-in-out";
            ...
            section4Left3.style.transition = "opacity is ease-in-out";
            ...
            section4Left4.style.transition = "opacity is ease-in-out";
        } else {
        ...
        if (scrollPosition > section4OffsetTop && scrollPosition < section4OffsetTop + innerHeight){
            ...
            section4RightImg.style.transition ="opacity is ease-in-out";
